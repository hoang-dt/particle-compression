...
template <typename t, int D = 3, int K = 4> void Encode(t* Block, int B, i64 S, i8& N, bitstream* Bs);
template <typename t, int D = 3, int K = 4> void Decode(t* Block, int B, i64 S, i8& N, bitstream* Bs);
template <typename t, int D = 3, int K = 4> void Decode2(t* Block, int B, i64 S, i8& N, bitstream* Bs);
template <typename t, int D = 3, int K = 4> void Decode3(t* Block, int B, i64 S, i8& N, bitstream* Bs);
template <typename t, int D = 3, int K = 4> void Decode4(t* Block, int B, i64 S, i8& N, bitstream* Bs);
