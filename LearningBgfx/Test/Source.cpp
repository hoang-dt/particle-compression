...
public:
  ...
  {
    particles_ = parse_gro("D:/Datasets/output.gro");
  ...
  bool update() override
  {
    if (!entry::processEvents(m_width, m_height, m_debug, m_reset, &m_mouseState))
    {
      ...
      else
      {
        ...
        // 11x11 cubes
        const uint32_t numInstances = particles_[0].size();
        ...
        if (numInstances == bgfx::getAvailInstanceDataBuffer(numInstances, instanceStride))
        {
          ...
          for (uint32_t yy = 0; yy < numInstances; ++yy)
          {
            ...
            mtx[12] = particles_[0][yy].pos.x;
            mtx[13] = particles_[0][yy].pos.y;
            mtx[14] = particles_[0][yy].pos.z;
